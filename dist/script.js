        ...
        switch (item.nodeName) {
          ...
          case 'INPUT':
            if (item.getAttribute('type') === 'checkbox') {
              i === 0 ? state[prop] = "Froid" : state[prop] = "Chaud";
...
var modals = function modals() {
  ...
  function calcScroll() {
    ...
    var scrollWidth = div.offsetWidth - div.clientHeight;
    div.remove();
    return scrollWidth;
  }
  ...
  bindModal('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_end_close', false); // showByTime('.popup_engineer', 60000)
};
